...
#[doc = "Key unlock for AESADV power enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum KeyUnlock {
    #[doc = "0: Lock pwren"]
...
#[doc = "Field `KEY_UNLOCK` reader - Key unlock for AESADV power enable"]
...
#[doc = "Field `KEY_UNLOCK` writer - Key unlock for AESADV power enable"]
...
impl R {
    ...
    #[doc = "Bits 24:31 - Key unlock for AESADV power enable"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 24:31 - Key unlock for AESADV power enable"]
    #[inline(always)]
    pub fn key_unlock(&mut self) -> KeyUnlockW<'_, AesadvPwrenSpec> {
