...
#[doc = "Key unlock for UART1 reset control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum KeyUnlockw {
    #[doc = "0: Lock reset"]
...
#[doc = "Field `KEY_UNLOCK` writer - Key unlock for UART1 reset control"]
...
impl W {
    ...
    #[doc = "Bits 24:31 - Key unlock for UART1 reset control"]
    #[inline(always)]
    pub fn key_unlock(&mut self) -> KeyUnlockW<'_, Uart1RstctlSpec> {
