...
#[doc = "Key unlock for SPI0 clock config\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum KeyUnlock {
    #[doc = "0: Lock config"]
...
#[doc = "Field `KEY_UNLOCK` reader - Key unlock for SPI0 clock config"]
...
#[doc = "Field `KEY_UNLOCK` writer - Key unlock for SPI0 clock config"]
...
impl R {
    ...
    #[doc = "Bits 24:31 - Key unlock for SPI0 clock config"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 24:31 - Key unlock for SPI0 clock config"]
    #[inline(always)]
    pub fn key_unlock(&mut self) -> KeyUnlockW<'_, Spi0ClkcfgSpec> {
